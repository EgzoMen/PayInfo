...
class Ui_StartWindow(object):
    def setupUi(self, StartWindow):
        ...
        self.label.setObjectName(u"mounth_spent_lbl")
        self.label.setGeometry(QRect(380, 300, 381, 181))
        self.widget = QWidget(self.centralwidget)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(380, 21, 381, 271))
        ...
        self.save_record_btn = QPushButton(self.widget)
        self.save_record_btn.setObjectName(u"save_record_btn")

        self.horizontalLayout_2.addWidget(self.save_record_btn)

        self.show_mounth_spent_btn = QPushButton(self.widget)
        self.show_mounth_spent_btn.setObjectName(u"show_mounth_spent_btn")

        self.horizontalLayout_2.addWidget(self.show_mounth_spent_btn)
    ...
    def retranslateUi(self, StartWindow):
        ...
        self.show_mounth_spent_btn.setText(QCoreApplication.translate("StartWindow", u"\u041e\u0442\u0447\u0451\u0442 \u0437\u0430 \u043c\u0435\u0441\u044f\u0446", None))
    # retranslateUi
